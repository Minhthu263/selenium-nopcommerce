...
import com.nopcommerce.demo.helper.enumeration.BYLOCATOR;
...
public class BasePage {
    ...
    protected void forwawrdToPage(WebDriver driver) {
    ...
    protected String getTextElemeEnt(WebDriver driver, String locator) {
    ...
    protected void uncheckToDefaultCheckbox(WebDriver driver, String locator, String... params) {
